        ...
        <div className="container max-w-3xl mx-auto flex justify-between">
          ...
          <div className="flex gap-x-2">
            ...
            <button
              ...
              className="hover:border-accent-1-dark bg-background-dark border-2 px-2 hidden dark:block"
            ...
            <button
              ...
              className="border-black hover:border-accent-1-light bg-background-light border-2 px-2 block dark:hidden"
              onClick={() => toggle_dark_mode()}
            >
              dark mode
            </button>
